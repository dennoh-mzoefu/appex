                                        ...
                                        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                                            <div class="card col-lg-4 mx-auto">
                                                <div class="card-body px-5 py-5">
                                                    <h3 class="card-title text-left mb-3">Deposit amount</h3>

                                                    <form action="depositHandler.php" method="POST">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="phone_number_money" style="color: white" class="form-control p_input" required autocomplete="off" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Amount *</label>
                                                            <input type="number" name="amount" style="color: white" class="form-control p_input" required autocomplete="off" />
                                                        </div>
